        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Select a batch to view student attendance</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {batches.length > 0 ? (
                    batches.map((batch) => (
                        <Link
                            key={batch.id}
                            href={`/admin/attendance/${batch.id}`}
                    ...
                    <div className="col-span-full bg-white p-12 rounded-xl border border-gray-200 border-dashed text-center">
                        ...
                        <p className="text-gray-500">Create a batch first to track attendance.</p>
